...
export const Process: React.FC<ProcessProps> = ({ onOpenChat }) => {
  ...
  return (
    <section id="process" className="py-24 md:py-32 bg-gray-50/50 relative border-t border-gray-200">
      <SEO
        title="Processo de Criacao de Sites"
        description="Entenda o processo de briefing, estrutura visual, desenvolvimento e entrega de sites profissionais na PH.static."
        keywords={['Processo de Criacao de Sites', 'Briefing de Site', 'Desenvolvimento Web Profissional']}
        url={buildPageUrl(content.site.URL, 'process')}
        breadcrumbs={[
          { name: 'Home', item: buildPageUrl(content.site.URL, 'home') },
          { name: 'Processo', item: buildPageUrl(content.site.URL, 'process') }
        ]}
      />

      <div className="container mx-auto px-4 md:px-8 max-w-7xl">
        <SectionTitle
          title="Um processo simples para voce aprovar com seguranca"
          subtitle="Sem caixa preta. Cada etapa existe para reduzir risco, alinhar expectativa e acelerar a entrega."
        />

        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-12">
          <div className="rounded-2xl border border-gray-200 bg-white px-5 py-4 shadow-sm">
            <p className="text-xs font-bold uppercase tracking-[0.18em] text-primary-600 mb-2">Sem improviso</p>
            <p className="text-sm text-gray-600">Briefing, proposta e execucao seguem uma ordem clara para evitar retrabalho.</p>
          </div>
          <div className="rounded-2xl border border-gray-200 bg-white px-5 py-4 shadow-sm">
            <p className="text-xs font-bold uppercase tracking-[0.18em] text-primary-600 mb-2">Aprovacao por etapas</p>
            <p className="text-sm text-gray-600">Voce acompanha o raciocinio do projeto antes da entrega final.</p>
          </div>
          <div className="rounded-2xl border border-gray-200 bg-white px-5 py-4 shadow-sm">
            <p className="text-xs font-bold uppercase tracking-[0.18em] text-primary-600 mb-2">Decisao rapida</p>
            <p className="text-sm text-gray-600">O objetivo e tirar o projeto do papel com rapidez, sem perder qualidade.</p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-0 relative z-10">
            <div className="lg:col-span-7 p-8 md:p-12 flex flex-col justify-center border-b lg:border-b-0 lg:border-r border-gray-800">
              <div className="flex items-center gap-3 mb-6">
                ...
                <span className="text-xs font-bold uppercase tracking-widest text-primary-400">Investimento protegido</span>
              </div>

              <h3 className="text-2xl md:text-3xl font-display font-bold mb-4 text-white">
                Voce aprova o processo sem entrar no escuro
              </h3>
              <p className="text-gray-400 leading-relaxed text-sm md:text-base mb-8">
                <SmartText>
                  O modelo 50/50 protege os dois lados. O sinal reserva agenda e inicia a producao. A parcela final entra depois da aprovacao, quando a entrega ja esta validada.
                </SmartText>
              </p>
              ...
              {financialNote && (
                <div className="mt-auto bg-gray-800/80 backdrop-blur-sm p-4 rounded-xl border border-gray-700/50 flex gap-3 text-xs text-gray-400">
                  <span className="text-primary-400 shrink-0">i</span>
                  <p>{financialNote}</p>
                </div>
              )}
            </div>
              ...
              <div className="space-y-6">
                <div className="flex justify-between items-center group cursor-default">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="text-xs text-gray-500 font-bold uppercase">Inicio do projeto</p>
                ...
                <div className="flex justify-between items-center group cursor-default">
                  ...
                  <span className="text-gray-600 group-hover:text-green-400 transition-colors">Aprovacao</span>
                </div>
              </div>
