  ...
  return (
    <section id="about" className="py-24 bg-gray-50 overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div className={`flex flex-col ${ABOUT_CONFIG.IMAGE_URL ? 'xl:flex-row' : 'items-center'} gap-12 xl:gap-20`}>
          
          {/* Image Column (Left on Desktop) - Only if URL exists */}
          {ABOUT_CONFIG.IMAGE_URL && (
            <motion.div 
          ...
          <div className={`w-full ${ABOUT_CONFIG.IMAGE_URL ? 'xl:w-[60%]' : 'max-w-4xl'}`}>
            <SectionTitle 
