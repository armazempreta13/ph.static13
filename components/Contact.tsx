...
import { Mail, MessageSquare, Send, CheckCircle2, AlertCircle, ArrowRight, ArrowUpRight, Zap, ShieldCheck, Clock3 } from 'lucide-react';
...
export const Contact: React.FC = () => {
  ...
  const defaultPackage = SERVICE_PACKAGES.find((item) => item.highlight) ?? SERVICE_PACKAGES[0];

  const contactSchema = {
    '@context': 'https://schema.org',
    '@type': 'ContactPage',
    name: 'Contato PH.static',
    url: buildPageUrl(content.site.URL, 'contact'),
    description: 'Solicite orcamento para criacao de sites, landing pages e projetos sob medida.'
  };

  const [formData, setFormData] = useState<ContactFormData>({
    name: '',
    email: '',
    projectType: defaultPackage?.title || 'Site Profissional',
    budget: 'Nao tenho certeza',
    message: ''
  });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (isMounted.current) {
        setErrorMsg(error?.message || 'Nao foi possivel enviar o formulario agora.');
      }
    } finally {
      if (isMounted.current) {
  ...
  const handleWhatsAppRedirect = () => {
    const text = 'Ola! Enviei um formulario no site e gostaria de agilizar o atendimento por aqui.';
  ...
  return (
    <section id="contact" className="py-24 md:py-32 bg-white relative overflow-hidden">
      <SEO
        ...
        description="Solicite orcamento para criacao de sites, landing pages e projetos sob medida com foco em SEO, performance e conversao."
        keywords={['Contato Desenvolvedor Web', 'Orcamento Site', 'Orcamento Landing Page', 'Criacao de Sites Brasilia']}
        url={buildPageUrl(content.site.URL, 'contact')}
        breadcrumbs={[
          { name: 'Home', item: buildPageUrl(content.site.URL, 'home') },
          { name: 'Contato', item: buildPageUrl(content.site.URL, 'contact') }
        ]}
          ...
          <div className="lg:w-5/12 space-y-10">
            <div>
              ...
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold mb-6 tracking-tight text-gray-900">
                Vamos transformar sua presenca digital em uma ferramenta de vendas?
              </h2>

              <p className="text-gray-500 text-lg leading-relaxed max-w-md font-light">
                Se voce ja tem uma oferta boa, o proximo passo e apresentar isso com mais clareza, autoridade e velocidade. O formulario abaixo me ajuda a te responder melhor.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 gap-4">
              ...
              >
                ...
                <div className="flex-1 relative z-10">
                  <p className="text-xs text-green-600 font-bold uppercase tracking-wider mb-0.5">Resposta rapida</p>
              ...
              >
                ...
                <div className="flex-1 relative z-10">
                  <p className="text-xs text-primary-600 font-bold uppercase tracking-wider mb-0.5">Propostas e documentos</p>
                  ...
                  {isSuccess ? (
                    ...
                    >
                      ...
                      <p className="text-gray-500 mb-8 max-w-sm">
                        Recebi suas informacoes com sucesso. Vou analisar o contexto e retornar o quanto antes.
                      </p>
                    ...
                    >
                      <div className="flex items-center justify-between mb-2">
                        <div>
                          <h3 className="text-xl font-bold text-gray-900">Fale sobre o projeto</h3>
                          <p className="text-sm text-gray-500 mt-1">Quanto mais claro o contexto, melhor fica a proposta.</p>
                        </div>
                        <span className="text-xs text-gray-400">* Campos obrigatorios</span>
                      </div>
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="relative">
                            <select
                              ...
                              className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3.5 text-gray-900 appearance-none cursor-pointer focus:border-primary-500 focus:ring-4 focus:ring-primary-100 outline-none transition-all font-medium"
                            >
                              <option>Nao tenho certeza</option>
                              <option>Ate R$ 1.500</option>
                      ...
                      <div className="space-y-2">
                        ...
                        <textarea
                          ...
                          placeholder="Explique o que voce vende, qual problema o site precisa resolver e se existe algum prazo importante."
                        />
                      </div>

                      <div className="rounded-2xl bg-gray-50 border border-gray-100 p-4 text-sm text-gray-600">
                        Quanto mais contexto voce passar, mais precisa fica a proposta. Se ainda estiver em fase inicial, tudo bem: eu te ajudo a organizar o escopo.
                      </div>
                      ...
                      >
                        Solicitar analise do projeto
                      </Button>

                      <p className="text-center text-xs text-gray-400 mt-4">
                        Seus dados serao usados apenas para retorno comercial e organizacao da proposta.
                      </p>
                    </motion.form>
                  )}
                </AnimatePresence>
