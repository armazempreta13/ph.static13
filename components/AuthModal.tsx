...
import { X, Mail, Lock, User, ArrowRight, AlertCircle, Shield, Briefcase, Zap } from 'lucide-react';
...
export const AuthModal: React.FC<AuthModalProps> = ({ onClose, onLoginSuccess }) => {
  ...
  const handleAuth = async (e: React.FormEvent) => {
    ...
    // --- BYPASS DE ADMIN (SEM BANCO DE DADOS) ---
    // Simula uma autenticação rápida para testes
            ...
            <div className="p-8">
                ...
                <div className="mt-6 text-center">
                    <p className="text-xs text-gray-400 flex items-center justify-center gap-1">
                        <Zap size={12} className="text-yellow-500"/> Ambiente de Demonstração
                    </p>
                </div>
            </div>
        </motion.div>
