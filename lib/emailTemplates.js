...
const iconCircleCheck = () => `
  <div style="text-align:center; margin-bottom:18px;">
    <div style="
      ...
      line-height:50px;
    ">
      <img src="https://i.imgur.com/GndpLzJ.png" width="24" style="margin-top:13px; border:0;" alt="✓">
    </div>
  </div>
`;
...
export const buildChatbotClientHtml = (payload) => buildBaseEmail(`
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ${dataRow('Serviço', escapeHtml(payload.projectType))}
    ${payload.timeline ? dataRow('Prazo desejado', escapeHtml(payload.timeline), true) : ''}
  </table>
